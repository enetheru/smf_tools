...
add_test(NAME smf_info_unknown COMMAND $<TARGET_FILE:smf_info> --beans)
...
# == Other Tests ==
add_test(NAME smf_info_data COMMAND $<TARGET_FILE:smf_info> -vvv -f ${TEST_DATA_DIR}/data.smf)
set_tests_properties(smf_info_data PROPERTIES LABELS "smf_info")

add_test(NAME smf_info_data2 COMMAND $<TARGET_FILE:smf_info> -f ${TEST_DATA_DIR}/data.smf -f ${TEST_DATA_DIR}/data.smf)
set_tests_properties(smf_info_data2 PROPERTIES LABELS "smf_info" WILL_FAIL TRUE)